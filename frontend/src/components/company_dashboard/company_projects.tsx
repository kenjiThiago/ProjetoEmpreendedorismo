...
export function CompanyProjects({
  ...
  // Mapeamento completo dos status possíveis conforme CHECK constraint do banco
  const getStatusDisplay = (estado: ProjectStatus) => {
    switch (estado) {
      case "ANALISE":
        return {
          color: "text-orange-400 bg-orange-400/10 border-orange-400/20",
          icon: HelpCircle, // Ícone de interrogação ou similar para análise
          label: "Em Análise",
        }
    ...
    >
      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        ...
        <div className="flex flex-col gap-3 md:flex-row">
          ...
          {/* Select atualizado com todos os status possíveis */}
          <select
            ...
            return (
              ...
              >
                ...
                <div className="mt-2 flex w-full items-center gap-6 border-gray-800 border-t pt-4 md:mt-0 md:w-auto md:border-t-0 md:pt-0">
                  {/* Indicador de Interesse (Prova Social para a Empresa) */}
                  ...
                  <button
                    className="btn-secondary flex items-center gap-2 whitespace-nowrap px-4 py-2 text-sm"
                    type="button"
                  >
